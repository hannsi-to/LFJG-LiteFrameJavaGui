...
class CefRequestContext_N extends CefRequestContext implements CefNative {
    ...
    static CefRequestContext_N getGlobalContextNative() {
        ...
        } else if (result != null && globalInstance.N_CefHandle == result.N_CefHandle) {
    ...
    private static native CefRequestContext_N N_CreateContext(CefRequestContextHandler handler);
