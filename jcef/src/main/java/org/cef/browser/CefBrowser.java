...
public interface CefBrowser {
     ...
     */
    CefFrame getFrameByIdentifier(String identifier);
     ...
     * @return The frame or NULL if not found
     */
    CefFrame getFrameByName(String name);
     ...
     */
    Vector<String> getFrameIdentifiers();
     ...
     */
    void runFileDialog(FileDialogMode mode, String title, String defaultFilePath, Vector<String> acceptFilters, int selectedAcceptFilter, CefRunFileDialogCallback callback);
     ...
     */
    void find(String searchText, boolean forward, boolean matchCase, boolean findNext);
     ...
     */
    void openDevTools(Point inspectAt);
