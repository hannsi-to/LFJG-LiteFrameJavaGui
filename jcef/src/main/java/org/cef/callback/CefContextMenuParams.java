...
public interface CefContextMenuParams {
    ...
    final class TypeFlags {
        ...
        public final static int CM_TYPEFLAG_PAGE = 1; //!< The top page is selected.
    ...
    final class MediaStateFlags {
        ...
        public final static int CM_MEDIAFLAG_ERROR = 1;
    ...
    final class EditStateFlags {
        ...
        public final static int CM_EDITFLAG_CAN_UNDO = 1;
