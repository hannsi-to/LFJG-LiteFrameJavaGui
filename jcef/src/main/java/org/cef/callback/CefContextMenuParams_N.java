...
class CefContextMenuParams_N extends CefNativeAdapter implements CefContextMenuParams {
    ...
    private native int N_GetTypeFlags(long self);
    ...
    private native MediaType N_GetMediaType(long self);

    private native int N_GetMediaStateFlags(long self);

    private native String N_GetSelectionText(long self);

    private native String N_GetMisspelledWord(long self);

    private native boolean N_GetDictionarySuggestions(long self, Vector<String> suggestions);

    private native boolean N_IsEditable(long self);

    private native boolean N_IsSpellCheckEnabled(long self);

    private native int N_GetEditStateFlags(long self);
}
