...
public abstract class CefClientHandler implements CefNative {
    ...
    private final HashMap<String, Long> N_CefHandle = new HashMap<>();
    private final Vector<CefMessageRouter> msgRouters = new Vector<>();
    ...
    private native void N_CefClientHandler_CTOR();

    private native void N_addMessageRouter(CefMessageRouter h);

    private native void N_removeContextMenuHandler(CefContextMenuHandler h);

    private native void N_removeDialogHandler(CefDialogHandler h);

    private native void N_removeDisplayHandler(CefDisplayHandler h);

    private native void N_removeDownloadHandler(CefDisplayHandler h);

    private native void N_removeDragHandler(CefDragHandler h);

    private native void N_removeFocusHandler(CefFocusHandler h);

    private native void N_removeJSDialogHandler(CefJSDialogHandler h);

    private native void N_removeKeyboardHandler(CefKeyboardHandler h);

    private native void N_removeLifeSpanHandler(CefLifeSpanHandler h);

    private native void N_removeLoadHandler(CefLoadHandler h);

    private native void N_removePrintHandler(CefPrintHandler h);

    private native void N_removeMessageRouter(CefMessageRouter h);

    private native void N_removeRenderHandler(CefRenderHandler h);

    private native void N_removeRequestHandler(CefRequestHandler h);

    private native void N_removeWindowHandler(CefWindowHandler h);

    private native void N_CefClientHandler_DTOR();
}
