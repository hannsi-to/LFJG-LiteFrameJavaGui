...
class CefPostData_N extends CefPostData implements CefNative {
    ...
    private native static CefPostData_N N_Create();
    ...
    private native int N_GetElementCount(long self);

    private native void N_GetElements(long self, Vector<CefPostDataElement> elements);

    private native boolean N_RemoveElement(long self, CefPostDataElement element);

    private native boolean N_AddElement(long self, CefPostDataElement element);
