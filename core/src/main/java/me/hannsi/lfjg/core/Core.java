...
public class Core {
    ...
    public static class NVGColor {
        public static final String PACKAGE = "org.lwjgl.nanovg.NVGColor";
        ...
        private static Object createNVGColorInstance(Class<?> nvgColorClass, Core.NVGColor color) throws Exception {
            Object instance = nvgColorClass.getDeclaredConstructor().newInstance();

            Field r = nvgColorClass.getField("r");
            Field g = nvgColorClass.getField("g");
            Field b = nvgColorClass.getField("b");
            Field a = nvgColorClass.getField("a");

            r.setFloat(instance, color.r);
            g.setFloat(instance, color.g);
            b.setFloat(instance, color.b);
            a.setFloat(instance, color.a);
    ...
    public static class NanoVG {
        public static final String PACKAGE = "org.lwjgl.nanovg.NanoVG";
        ...
        static {
            NVG_ALIGN_LEFT = getStaticIntField(PACKAGE, "NVG_ALIGN_LEFT");
            NVG_ALIGN_CENTER = getStaticIntField(PACKAGE, "NVG_ALIGN_CENTER");
            NVG_ALIGN_RIGHT = getStaticIntField(PACKAGE, "NVG_ALIGN_RIGHT");
            NVG_ALIGN_TOP = getStaticIntField(PACKAGE, "NVG_ALIGN_TOP");
            NVG_ALIGN_MIDDLE = getStaticIntField(PACKAGE, "NVG_ALIGN_MIDDLE");
            NVG_ALIGN_BOTTOM = getStaticIntField(PACKAGE, "NVG_ALIGN_BOTTOM");
            NVG_ALIGN_BASELINE = getStaticIntField(PACKAGE, "NVG_ALIGN_BASELINE");
        }
        ...
        public static void nvgCurrentTransform(long ctx, float[] xform) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgCurrentTransform", ctx, xform);
        }
        ...
        public static void nvgRestore(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgRestore", ctx);
        }
        ...
        public static void nvgTranslate(long ctx, float x, float y) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgTranslate", ctx, x, y);
        }
        ...
        public static void nvgScale(long ctx, float x, float y) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgScale", ctx, x, y);
        }
        ...
        public static void nvgSave(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgSave", ctx);
        }
        ...
        public static void nvgBeginFrame(long ctx, float windowWidth, float windowHeight, float devicePixelRatio) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgBeginFrame", ctx, windowWidth, windowHeight, devicePixelRatio);
        }
        ...
        public static void nvgEndFrame(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgEndFrame", ctx);
        }
        ...
        public static void nvgBeginPath(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgBeginPath", ctx);
        }
        ...
        public static void nvgClosePath(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgClosePath", ctx);
        }
        ...
        public static void nvgRotate(long ctx, float angle) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgRotate", ctx, angle);
        }

        public static void nvgFillColor(long ctx, Core.NVGColor color) {
            if (!enableLFJGRenderSystem) {
                return;
            }

            try {
                Class<?> nvgColorClass = Class.forName(Core.NVGColor.PACKAGE);
                Object nvgColorInstance = Core.NVGColor.createNVGColorInstance(nvgColorClass, color);
                Object ignore = invokeStaticMethod(NanoVG.PACKAGE, "nvgFillColor", ctx, nvgColorInstance);
            } catch (Exception e) {
                if (!CORE_SYSTEM_DEBUG) {
                    return;
                }
        ...
        public static void nvgFontSize(long ctx, float size) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgFontSize", ctx, size);
        }
        ...
        public static void nvgTextAlign(long ctx, int align) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgTextAlign", ctx, align);
        }
        ...
        public static void nvgFontFace(long ctx, CharSequence font) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgFontFace", ctx, font);
        }
        ...
        public static void nvgTransform(long ctx, float a, float b, float c, float d, float e, float f) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgTransform", ctx, a, b, c, d, e, f);
        }
        ...
        public static void nvgResetTransform(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgResetTransform", ctx);
        }
        ...
        public static float nvgTextBounds(long ctx, float x, float y, CharSequence string, @Nullable float[] bounds) {
            ...
            Object result = invokeStaticMethod(PACKAGE, "nvgTextBounds", ctx, x, y, string, bounds);
            if (result == null) {
                return -1f;
            }
        ...
        public static void nvgTextMetrics(long ctx, @Nullable float[] ascender, @Nullable float[] descender, @Nullable float[] lineh) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgTextMetrics", ctx, ascender, descender, lineh);
        }
        ...
        public static float nvgText(long ctx, float x, float y, CharSequence string) {
            ...
            Object result = invokeStaticMethod(PACKAGE, "nvgText", ctx, x, y, string);
            if (result == null) {
                return -1f;
            }
        ...
        public static void nvgFill(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgFill", ctx);
        }

        public static int nvgCreateFontMem(long ctx, @NotNull CharSequence name, @NotNull ByteBuffer data, boolean freeData) {
            if (!enableLFJGRenderSystem) {
                return -1;
            }

            Object result = invokeStaticMethod(PACKAGE, "nvgCreateFontMem", ctx, name, data, freeData);
            if (result == null) {
                return -1;
            }
        ...
        public static void nvgMoveTo(long ctx, float x, float y) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgMoveTo", ctx, x, y);
        }
        ...
        public static void nvgLineTo(long ctx, float x, float y) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgLineTo", ctx, x, y);
        }
        ...
        public static void nvgStrokeWidth(long ctx, float size) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgStrokeWidth", ctx, size);
        }

        public static void nvgStrokeColor(long ctx, @NotNull Core.NVGColor color) {
            if (!enableLFJGRenderSystem) {
                return;
            }
            ...
            try {
                Class<?> nvgColorClass = Class.forName(Core.NVGColor.PACKAGE);
                Object nvgColorInstance = Core.NVGColor.createNVGColorInstance(nvgColorClass, color);
                Object ignore = invokeStaticMethod(NanoVG.PACKAGE, "nvgStrokeColor", ctx, nvgColorInstance);
            } catch (Exception e) {
                if (!CORE_SYSTEM_DEBUG) {
                    return;
                }
        ...
        public static void nvgStroke(long ctx) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgStroke", ctx);
        }
        ...
        public static void nvgFontBlur(long ctx, float blur) {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "nvgFontBlur", ctx, blur);
        }
    }
    ...
    public static class GL11 {
        ...
        public static void glPopAttrib() {
            ...
            Object ignore = invokeStaticMethod(PACKAGE, "glPopAttribglPopAttrib");
        }
