...
public class MSDFMain implements LFJGFrame {
    ...
    public void drawFrame() {
        textRenderer.draw(TextFormatType.SPASE_X + "{40}しるT" + TextFormatType.DOUBLE_STRIKETHROUGH + "しるT" + TextFormatType.RESET + TextFormatType.SPASE_Y + "{-40}" + TextFormatType.NEWLINE + "ばは" + TextFormatType.DARK_BLUE + TextFormatType.STRIKETHROUGH + "あ" + TextFormatType.GOLD + "ほ");
