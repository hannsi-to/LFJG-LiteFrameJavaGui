...
public class Demo1 implements IScene {
    ...
    GLTriangles glTriangles1;
    GLTriangles glTriangles2;
    GLTriangles glTriangles3;
    GLRect glRect31;
...
//        glPolygon1.put().position(new Vector2f(offsetX, offsetY)).color(Color.BLACK);
...
//        glPolygon1.drawType(DrawType.LINE_STRIP).outLineWidth(2);
//        glPolygon1.rendering();
//        offsetX += offset + step;
//        glPolygon2 = new GLPolygon("GLPolygon2");
//        glPolygon2.put().position(new Vector2f(offsetX, offsetY)).color(Color.BLACK);
...
//        glPolygon2.drawType(DrawType.LINE_STRIP).outLineWidth(4);
//        glPolygon2.rendering();
//        offsetX += offset + step;
//        glPolygon3 = new GLPolygon("GLPolygon3");
//        glPolygon3.put().position(new Vector2f(offsetX, offsetY)).color(Color.BLACK);
...
//        glPolygon3.drawType(DrawType.LINE_STRIP).outLineWidth(6);
...
//        }
//        glPolygon5.drawType(DrawType.LINE_LOOP).outLineWidth(6);
...
//        }
//        glPolygon6.drawType(DrawType.LINE_LOOP).outLineWidth(2);
...
//        }
//        glPolygon8.drawType(DrawType.LINE_LOOP).outLineWidth(6);
...
//        }
//        glPolygon9.drawType(DrawType.LINE_LOOP).outLineWidth(2);
