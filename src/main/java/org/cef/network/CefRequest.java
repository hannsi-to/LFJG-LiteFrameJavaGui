...
public abstract class CefRequest implements AutoCloseable {
    ...
    public String toString() {
        ...
        returnValue.append("\n  transitionType: ").append(getTransitionType());
        returnValue.append("\n  firstPartyForCookies: ").append(getFirstPartyForCookies());
        returnValue.append("\n  referrerURL: ").append(getReferrerURL());
        returnValue.append("\n  referrerPolicy: ").append(getReferrerPolicy());
        returnValue.append("\n    ").append(getMethod()).append(" ").append(getURL()).append(" HTTP/1.1\n");
        ...
        for (Entry<String, String> entry : entrySet) {
            ...
            returnValue.append("    ").append(key).append("=").append(entry.getValue()).append("\n");
        ...
        if (pd != null) {
            returnValue.append(pd.toString(mimeType));
        }
