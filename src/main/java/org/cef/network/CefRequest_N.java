...
class CefRequest_N extends CefRequest implements CefNative {
    ...
    private native static CefRequest_N N_Create();
    ...
    private native void N_SetReferrer(long self, String url, ReferrerPolicy policy);

    private native String N_GetReferrerURL(long self);

    private native ReferrerPolicy N_GetReferrerPolicy(long self);

    private native CefPostData N_GetPostData(long self);

    private native void N_SetPostData(long self, CefPostData postData);
    ...
    private native void N_GetHeaderMap(long self, Map<String, String> headerMap);

    private native void N_SetHeaderMap(long self, Map<String, String> headerMap);

    private native void N_Set(long self, String url, String method, CefPostData postData, Map<String, String> headerMap);
    ...
    private native ResourceType N_GetResourceType(long self);

    private native TransitionType N_GetTransitionType(long self);
}
