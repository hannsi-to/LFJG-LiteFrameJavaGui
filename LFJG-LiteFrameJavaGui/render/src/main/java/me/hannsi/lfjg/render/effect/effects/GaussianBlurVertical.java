...
public class GaussianBlurVertical extends EffectBase {
    ...
    public void setUniform(GLObject baseGLObject) {
        getFrameBuffer().getShaderProgramFBO().setUniform("direction", UploadUniformType.ON_CHANGE, new Vector2f(0, 1));
        getFrameBuffer().getShaderProgramFBO().setUniform("radius", UploadUniformType.ON_CHANGE, radiusY);
