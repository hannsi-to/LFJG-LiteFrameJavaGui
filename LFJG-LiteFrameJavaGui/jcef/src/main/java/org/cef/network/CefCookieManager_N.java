...
class CefCookieManager_N extends CefCookieManager implements CefNative {
    ...
    private static native CefCookieManager_N N_GetGlobalManager();
    ...
    private native boolean N_VisitAllCookies(long self, CefCookieVisitor visitor);

    private native boolean N_VisitUrlCookies(long self, String url, boolean includeHttpOnly, CefCookieVisitor visitor);

    private native boolean N_SetCookie(long self, String url, CefCookie cookie);

    private native boolean N_DeleteCookies(long self, String url, String cookieName);

    private native boolean N_FlushStore(long self, CefCompletionCallback handler);
}
