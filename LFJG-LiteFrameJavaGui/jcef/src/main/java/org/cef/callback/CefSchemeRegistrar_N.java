...
class CefSchemeRegistrar_N extends CefNativeAdapter implements CefSchemeRegistrar {
    ...
    private native boolean N_AddCustomScheme(String schemeName, boolean isStandard, boolean isLocal, boolean isDisplayIsolated, boolean isSecure, boolean isCorsEnabled, boolean isCspBypassing, boolean isFetchEnabled);
}
