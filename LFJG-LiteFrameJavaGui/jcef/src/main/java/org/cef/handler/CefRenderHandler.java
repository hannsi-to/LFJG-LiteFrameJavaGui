...
public interface CefRenderHandler {
     ...
     */
    boolean getScreenInfo(CefBrowser browser, CefScreenInfo screenInfo);
     ...
     */
    void addOnPaintListener(Consumer<CefPaintEvent> listener);
     ...
     * @param listener Code that gets executed after a frame was rendered.
     */
    void setOnPaintListener(Consumer<CefPaintEvent> listener);
     ...
     * @param listener Code that gets executed after a frame was rendered.
     */
    void removeOnPaintListener(Consumer<CefPaintEvent> listener);
     ...
     */
    boolean onCursorChange(CefBrowser browser, int cursorType);
