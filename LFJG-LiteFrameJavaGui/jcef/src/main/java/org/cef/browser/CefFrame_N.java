 ...
 */
class CefFrame_N extends CefNativeAdapter implements CefFrame, AutoCloseable {
    CefFrame_N() {
    }
    ...
    private native CefFrame N_GetParent(long self);

    private native void N_ExecuteJavaScript(long self, String code, String url, int line);
