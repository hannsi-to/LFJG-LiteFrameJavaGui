package me.hannsi.lfjg.testRender;
...
import me.hannsi.lfjg.testRender.debug.RenderDebug;
...
import me.hannsi.lfjg.testRender.system.mesh.persistent.*;
import me.hannsi.lfjg.testRender.system.rendering.DrawBatch;
import me.hannsi.lfjg.testRender.system.rendering.GLStateCache;
...
public class LFJGRenderContext {
    ...
    public static final int NO_ATTACH_VIDEO = -1;
    ...
    public static VertexBufferObject vertexBufferObject;
    public static ElementArrayBuffer elementArrayBuffer;
    public static DrawIndirectBuffer persistentMappedIBO;
    public static ShaderStorageBufferObject shaderStorageBufferObject;
    ...
    public static void init() {
        ...
        vertexBufferObject = new VertexBufferObject(MeshConstants.DEFAULT_FLAGS_HINT, LFJG_RENDER_CONTEXT_INITIAL_VBO_SIZE);
        elementArrayBuffer = new ElementArrayBuffer(MeshConstants.DEFAULT_FLAGS_HINT, LFJG_RENDER_CONTEXT_INITIAL_EBO_CAPACITY);
        persistentMappedIBO = new DrawIndirectBuffer(MeshConstants.DEFAULT_FLAGS_HINT, LFJG_RENDER_CONTEXT_INITIAL_IBO_CAPACITY);
        shaderStorageBufferObject = new ShaderStorageBufferObject(MeshConstants.DEFAULT_FLAGS_HINT, LFJG_RENDER_CONTEXT_INITIAL_SSBO_CAPACITY);
