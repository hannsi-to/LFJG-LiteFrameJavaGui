...
public class RenderSystemSetting {
    public static int RENDER_QUEUE_BACKGROUND = 1000;
    public static int RENDER_QUEUE_GEOMETRY = 2000;
    public static int RENDER_QUEUE_ALPHA_TEST = 3000;
    public static int RENDER_QUEUE_TRANSPARENT = 4000;
    public static int RENDER_QUEUE_OVERLAY = 5000;
    ...
    public static int LFJG_RENDER_CONTEXT_INITIAL_VBO_SIZE = 40960;
    ...
    public static int INSTANCE_PARAMETER_DEFAULT_VIDEO_INDEX = NO_ATTACH_VIDEO;
    ...
    public static int ELEMENT_ARRAY_BUFFER_ALIGNMENT = MIN_MAP_BUFFER_ALIGNMENT;
    public static boolean PERSISTENT_MAPPED_EBO_DEBUG = false;

    public static int DRAW_INDIRECT_BUFFER_ALIGNMENT = MIN_MAP_BUFFER_ALIGNMENT;
    public static boolean PERSISTENT_MAPPED_IBO_DEBUG = false;

    public static int SHADER_STORAGE_BUFFER_OBJECT_ALIGNMENT = MIN_MAP_BUFFER_ALIGNMENT;
