package me.hannsi.lfjg.testRender.renderers;
...
public enum BlendType implements IEnumTypeBase {
    ...
    SCREEN(4, "Screen", true, GL_ONE, GL_ONE_MINUS_SRC_COLOR, GL_ONE, GL_ONE_MINUS_SRC_ALPHA, GL_FUNC_ADD, GL_FUNC_ADD, false, false),
    SUBTRACT(5, "Subtract", true, GL_SRC_ALPHA, GL_ONE, GL_ONE, GL_ONE, GL_FUNC_REVERSE_SUBTRACT, GL_FUNC_ADD, false, false),
    MAX(6, "Max", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_MAX, GL_MAX, true, true),
    MIN(7, "Min", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_MIN, GL_MIN, true, true),
    INVERT(8, "Invert", true, GL_ONE_MINUS_DST_COLOR, GL_ZERO, GL_ONE, GL_ZERO, GL_FUNC_ADD, GL_FUNC_ADD, false, false),
    PREMULTIPLIED_ALPHA(9, "PremultipliedAlpha", true, GL_ONE, GL_ONE_MINUS_SRC_ALPHA, GL_ONE, GL_ONE_MINUS_SRC_ALPHA, GL_FUNC_ADD, GL_FUNC_ADD, false, false),
    ADD_NO_ALPHA(10, "AddNoAlpha", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_FUNC_ADD, GL_FUNC_ADD, false, false),
    SUBTRACT_NORMAL(11, "SubtractNormal", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_FUNC_SUBTRACT, GL_FUNC_SUBTRACT, false, false),
    DARKEN(12, "Darken", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_MIN, GL_MIN, false, false),
    LIGHTEN(13, "Lighten", true, GL_ONE, GL_ONE, GL_ONE, GL_ONE, GL_MAX, GL_MAX, false, false),
