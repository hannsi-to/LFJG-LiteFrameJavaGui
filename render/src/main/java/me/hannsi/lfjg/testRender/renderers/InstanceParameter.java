...
import static me.hannsi.lfjg.testRender.LFJGRenderContext.mainCamera;
...
public class InstanceParameter implements Cleanup {
    public static final int BYTES = 16 * Float.BYTES + 4 * Float.BYTES + 4 * Integer.BYTES + 4 * Integer.BYTES;
    ...
    InstanceParameter() {
        ...
        this.videoIndex = INSTANCE_PARAMETER_DEFAULT_VIDEO_INDEX;
    ...
    public InstanceParameter videoIndex(int videoIndex) {
    ...
    public InstanceParameter getToAddress(long address, Matrix4f vpMatrix) {
        ...
        address += Float.BYTES;
        UNSAFE.putInt(address, videoIndex);
        address += Float.BYTES;
